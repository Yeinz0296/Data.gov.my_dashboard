...
app.layout = html.Div(
    ...
    html.Div(
        children=[
            dcc.Checklist(
            id="malaysia_state",
            options=['Malaysia', 'Johor', 'Kedah', 'Kelantan', 'Melaka', 'Negeri Sembilan', 'Pahang', 'Pulau Pinang', 'Perak', 'Perlis', 'Selangor', 'Terengganu', 'Sabah', 'Sarawak', 'W.P. Kuala Lumpur', 'W.P. Labuan', 'W.P. Putrajaya'],
...
def electricity_consumption(state):
    df = pd.read_csv('labour_force_by_age_group_state_malaysia_1982_2021_dataset.csv')
